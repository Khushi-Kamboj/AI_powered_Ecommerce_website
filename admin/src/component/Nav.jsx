...
const Nav = () => {
  ...
  return (
    <div className='w-[100vw] md:h-[55px] h-[70px] bg-[#dcdbdbf8] z-10 fixed top-0 flex items-center justify-between px-[40px] overflow-x-hidden shadow-md shadow-black'>
